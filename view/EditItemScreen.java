...
public class EditItemScreen extends JFrame {
     ...
     * @author An H.
     */
    public EditItemScreen(String project, String userID, DefaultTableModel model, Project projectObject, int theSelectedRow) {
    ...
    private void setUpFrame() {
        ...
        itemNameField.setText(project); // Set the provided value
        constraints.gridx = 0;
        constraints.gridy = 0;
        add(projectNameLabel, constraints);
        constraints.gridx = 1;
        constraints.gridy = 0;
        add(itemNameField, constraints);
        ...
        saveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String projectName = itemNameField.getText();
